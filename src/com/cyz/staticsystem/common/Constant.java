package com.cyz.staticsystem.common;
...
public class Constant {
	...
	/**
	 * 百度外卖平台账号密码验证远程验证码请求地址
	 */
	public static final String URL_BDSTORE_GETTOKEN = "http://180.76.173.250:8101/merchant-system/order/getToten";
	/**
	 * 百度外卖平台账号密码验证远程请求登录
	 */
	public static final String URL_BDLOGIN = "http://180.76.173.250:8101/merchant-system/order/bdlogin";
	/**
